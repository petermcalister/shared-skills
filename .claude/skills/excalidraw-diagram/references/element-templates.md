...
Copy-paste JSON templates. Pull colors from `color-palette.md` based on semantic purpose.
...
```json
{
  ...
  "roughness": 0, "opacity": 100, "angle": 0,
  "seed": 44444, "version": 1, "versionNonce": 55555,
  "isDeleted": false, "groupIds": [], "boundElements": null,
...
{
  "type": "text", "id": "text1",
  "x": 130, "y": 132, "width": 120, "height": 25,
...
For curves: use 3+ points in `points` array (e.g., `[[0,0], [60,-30], [118,0]]`).
